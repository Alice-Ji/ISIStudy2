...
// -----------------------------
function saveState() {
  localStorage.setItem("auv_G_state", JSON.stringify({
    posts,
    collectedComments,
    shopNowClicks
  }));
...
function loadState() {
  const saved = localStorage.getItem("auv_G_state");
  if (saved) {
...
let posts = [
  {
    ...
    media: [
      "https://raw.githubusercontent.com/Alice-Ji/ISIStudy2/main/auv_G.mp4",
    ],
